  ...
  return (
    <div className="grid grid-cols-basic12">
      <Image
        ...
        className="col-start-2 col-end-8 row-start-1 row-end-4 w-32 h-32 z-10 rounded-full border-gold border-8"
      />
      <Image
        ...
        className="w-full h-72 col-start-1 col-end-13 row-start-3 row-end-9 border-l-8 border-b-8 border-l-red border-b-red"
      />
      <Image
        ...
        className="w-full h-52 col-start-5 col-end-13 row-start-8 row-end-12"
      />
    </div>
  );
}
